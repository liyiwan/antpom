...
public class CmdRspParser
{
    ...
    public CmdResultInfo parseReturnInfo(InputStream is, String cmd)
    {
        ...
        // 屏蔽历史记录和邮箱打印，因为信息太多。
        if (cmd.equals(CmdInterface.GetMail_BoxData.getCmds(CmdInterface.GetMail_BoxData)[0]))
        {
     ...
     * 解析命令的即时返回结果
     * 
     * @param jsReturnInfo 命令返回信息
     * @throws JSONException JSON解析出错信息
     */
    ...
    {
        BufferedReader reader = new BufferedReader(new InputStreamReader(is), 10240);
