...
public abstract class AbsConnMgr
{
     ...
     */
    public abstract CmdResultInfo sendCmd(String cmdStr, String content) throws ConnException;

    /**
     * 发送命令给连接端
     * @param cmdStr 含有命令字和参数的命令消息字符串
     * @throws ConnException 发送过程中出现连接异常
     */
    public abstract CmdResultInfo sendCmd(String cmdStr) throws ConnException;

    /**
     * 设置连接相关的信息类。
     * @param connInfo the connInfo to set
     */
