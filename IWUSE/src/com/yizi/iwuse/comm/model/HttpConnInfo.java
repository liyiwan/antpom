package com.yizi.iwuse.comm.model;
...
public class HttpConnInfo extends ConnInfo
{
    ...
    public HttpConnInfo(String user, String pwd, String addr, String prol)
    {
        super(user, pwd, addr);
        protocol = prol;
        ipPort = (prol.equalsIgnoreCase(HTTP_PROL) ? HTTP_PORT_DFT : HTTPS_PORT_DFT);
    }
    ...
    /**
     * @param cmdUrl the cmdUrl to set
     */
    ...
    /**
     * @param fileUrlPre the fileUrlPre to set
     */
    ...
    public int getIpPort()
    {
        ...
        return (protocol.equalsIgnoreCase(HTTP_PROL)) ? HTTP_PORT_DFT : HTTPS_PORT_DFT;
    }
    ...
    {
        return new StringBuilder().append("ip:").append(ipAddr).append(",port:").append(ipPort).append(",prol:")
                .append(protocol).append(",session:").append(sessionId).toString();
