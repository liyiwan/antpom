...
import com.yizi.iwuse.activity.WelcomeActivity;
...
public class IWuseUtil
{
    ...
    /**
     * @param info androidManifest.xml里面的版本号
     * @param ver 版本号头 如：V1
     * @return 版本号 :V1.001
     */
    ...
    /**
     * 格式化时间
     * @param time 时间 (String类型)yyyyMMddHHmmss
     * @return 格式化后的时间字符串
     */
    public static String formatTime(String time, String formatString)
    {
        ...
        else
        {
            ...
            // 根据不同地区格式化成不同的时间格式。
            // DateFormat format2 = EnumGlobal.getDateFormat(AppContext.instance().deviceServ.deviceInfo.nation);
            DateFormat format2 = DateFormat.getDateInstance(DateFormat.DEFAULT, AppContext.instance()
                    .getCurrentLocale());
            // 定义时间对象
            Date confDate = null;
            try
     ...
     * @return
     */
//    public static IWuseDialog createHintDlg(Context mContext, String message, String id)
//    {
...
//     * @return
//     */
//    public static IWuseDialog createHintDlg(Context mContext, String title, String message, String id)
//    {
//        final IWuseDialog dialog = new IWuseDialog(mContext, id);
//        dialog.setContentView(IWuseDialog.ENUM_DIALOG_VIEW.ONE_BUTTON_VIEW);
...
//     * @return
//     */
//    public static IWuseDialog createOkCancelDlg(Context mContext, String message, String id)
//    {
//        final IWuseDialog dialog = new IWuseDialog(mContext, id);
...
//    }
     ...
     * @return HIDDialog
     */
//    public static IWuseDialog createWaitingDlg(Context mContext, int resId, String id)
//    {
...
//    }
     ...
     * @return HIDDialog
     */
//    public static IWuseDialog createWaitingDlg(Context mContext, String message, String id)
//    {
//    	IWuseDialog WaitingDialog = new IWuseDialog(mContext, R.style.dialog_wait, id);
//        if (null == message)
//        {
...
//    }
     ...
     * @return HIDDialog
     */
//    public static IWuseDialog createLongMsgDlg(Context mContext, String message, String id)
//    {
...
//    }
     ...
     * @param offset 从开头第几个开始查找
     * @param target 查找的目标
     * @param siteList 列表
     * @return
     */
//    public static int binarySearchSite(int offset, char target, int specialSiteIndex, List<?> siteList)
//    {
//        int front = offset;
...
//                        if ((middle - 1 <= 0)
//                                || (middle - 1 >= 0 && siteList.get(middle - 1).pinyin.charAt(0) != target))
//                        {
//                            targetIndex = middle;
//                            findFlag = true;
//                            break;
...
//                        targetIndex++;
//                    }
//                    else if (targetIndex == specialSiteIndex && specialSiteIndex != lastOfList)
//                    {
//                        targetIndex++;
//                    }
//                }
...
//    }
     ...
     * @param singleLineEngWidth 每一行的英文物理宽度
     * @param text 需要截断的文字
     * @param container 显示text的容器
     * @param maxWidth 容器layout的宽度值
     * @param rawTextSize 初始配置中设置的字体大小
     * @param isMultiPic 初始配置中设置的字体大小
     */
    public static String formatStrTwoLine(int singleLineEngWidth, String text, TextView container, float maxWidth,
            int rawTextSize, boolean isMultiPic)
    {
        String rawString;
    ...
    public static String formatStrTwoLine(int singleLineEngWidth, String text)
    {
        ...
        else if (length > singleLineEngWidth && length <= (singleLineEngWidth * 2))
        {
            length = 0;
        ...
        // 如果大于2行的宽度
        {
            ...
            for (int i = 0; i < halSigleLineEngWidth - 1; i++)
            {
                ...
                {
                    returnStr.append("...");
                    returnStr.append(remainText.substring(remainText.length() - i - 1));
                    break;
                }
            }
        }
     ...
     * @param Container
     * @param text
     * @param maxLenght：显示的最大长度
     * @param maxWidth：textView的最大宽度
     * @return
     */
    public static String formatWrapContainer(TextView Container, String text, int maxLenght, int maxWidth)
    {
        if (Container == null || text == null)
        {
            return "";
...
//            StrictMode.setThreadPolicy(policy);
    ...
    public static synchronized void restartIWuse(Context activity)
    {
        ...
        if (null != activity)
        {
            ...
            mgr.set(AlarmManager.RTC, System.currentTimeMillis() + 2000, WelcomeActivity.pdIntent);
            System.exit(0);
        }
    }
